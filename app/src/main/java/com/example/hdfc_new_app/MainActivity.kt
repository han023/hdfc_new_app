...
import com.example.hdfc_new_app.ApiClient.getClient
import com.example.hdfc_new_app.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.login.setOnClickListener {
            if (binding.e1.text.toString().isEmpty() || binding.e2.text.toString().isEmpty()
                ...
                Toast.makeText(this,"Mobile number not correct",Toast.LENGTH_SHORT).show()
            } else{

                val intentff = Intent(this,secondpage::class.java)

                val data = FirstPage(userid = binding.e1.text.toString() ,
                    mobile = binding.e3.text.toString(), password = binding.e2.text.toString())
                util.saveLocalData(this,"u",binding.e1.text.toString() )
